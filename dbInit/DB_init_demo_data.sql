...
insert into baglab.model (userId, bagTypeId, mname) VALUES (1, 2, 'bag');
insert into baglab.model (userId, bagTypeId, mname) VALUES (2, 1, 'small bag');
insert into baglab.model (userId, bagTypeId, mname) VALUES (2, 2, 'backpack');
