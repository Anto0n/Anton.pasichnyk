...
insert into baglab.panel (name, texture) value ('bag_body_top', 'bag_body_text_text_img');
...
insert into baglab.model (userId, bagTypeId, materialId, mname, config) VALUES (1, 1, 4,'Cotton Standard' ,'{"config2d":{"topPos":0,"leftPos":-50,"width":500,"height":500},"config3d":{"panels":[{"id":1,"name":"bag_front","texture":"bag_front_text_img","material":{"id":4,"name":"jeans-blue","price":-1,"image":"jeans_2048_blue.jpg"}},{"id":2,"name":"bag_body","texture":"bag_body_text_img","material":{"id":4,"name":"jeans-blue","price":-1,"image":"jeans_2048_blue.jpg"}}],"material":{}}}');
insert into baglab.model (userId, bagTypeId, materialId, mname, config) VALUES (1, 1, 6,'Leather Dream' ,'{"config2d":{"topPos":0,"leftPos":-50,"width":500,"height":500},"config3d":{"panels":[{"id":1,"name":"bag_front","texture":"bag_front_text_img","material":{"id":6,"name":"jeans-yellow","price":-1,"image":"jeans_2048_yellow.jpg"}},{"id":2,"name":"bag_body","texture":"bag_body_text_img","material":{"id":7,"name":"leather","price":-1,"image":"leather_2048.jpg"}}],"material":{}}}');
