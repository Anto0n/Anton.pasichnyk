...
insert into baglab.model (userId, bagTypeId, materialId, mname, config) VALUES (1, 2, 7, '2d simple_no img', '{"image":"","config2d":{"topPos":101.96340909194947,"leftPos":49.11835227203369,"width":400,"height":400},"config3d":{"panels":[],"material":{}}}');
insert into baglab.model (userId, bagTypeId, materialId, mname, config) VALUES (1, 1, 4, 'leather_jeans 3d', '{"config2d":{"topPos":0,"leftPos":-50,"width":500,"height":500},"config3d":{"panels":[{"id":1,"name":"bag_front","texture":"bag_front_text_img","material":{"id":4,"name":"jeans-blue","price":-1,"image":"jeans_2048_blue.jpg"}},{"id":2,"name":"bag_body","texture":"bag_body_text_img","material":{"id":7,"name":"leather","price":-1,"image":"leather_2048.jpg"}}],"material":{}}}');
